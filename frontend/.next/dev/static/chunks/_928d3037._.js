...
function Login() {
    ...
    const lidaComLogin = async (e)=>{
        e.preventDefault();
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/login", {
                email,
                password
            });
...
_s(Login, "jtyDGpx/FkPv8tMbVZd+a9ptbMw=", false, function() {
    return [
...
//# sourceMappingURL=_928d3037._.js.map