...
function Cadastro() {
    ...
    const lidaComCadastro = async (e)=>{
        e.preventDefault();
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/cadastro", {
                name,
                email,
                password
            });
...
_s(Cadastro, "aeVA6EMesyHNP7TiyRPea1/HyXk=");
_c = Cadastro;
var _c;
...
//# sourceMappingURL=_164dc9c3._.js.map