...
function Login() {
    ...
    const lidaComLogin = async (e)=>{
        e.preventDefault();
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/login", {
                email,
                password
            });
            localStorage.setItem("token", res.data.token);
            setMsg("Login executado!");
        } catch  {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2f001a4a._.js.map