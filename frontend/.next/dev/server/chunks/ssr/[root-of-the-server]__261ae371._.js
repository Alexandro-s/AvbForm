...
function Cadastro() {
    ...
    const lidaComCadastro = async (e)=>{
        e.preventDefault();
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/cadastro", {
                name,
                email,
                password
            });
            ...
            setMsg("Error no Cadastro do usuario");
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__261ae371._.js.map